...
export class UserService {
  ...
  private followUrl='http://localhost:8089/follow'
  ...
  getFollowing(userid: number): Observable<Object>{
    return this.http.get(`http://localhost:8089/follow/following/`+`${userid}`)
  }

  getFollower(userid: number): Observable<Object>{
    return this.http.get(`http://localhost:8089/follow/follower/`+`${userid}`)
  }
